...
(function (a) {
    a.jSlots = function (c, b) {
        ...
        a.jSlots.defaultOptions = {number: 3, winnerNumber: 1, spinner: "", spinEvent: "click", onStart: a.noop, onEnd: a.noop, onWin: a.noop, easing: "swing", time: 7000, loops: 6};
        ...
        d.Slot.prototype = {spinEm: function () {
            var e = this;
            e.$el.css("top", -d.listHeight).animate({top: "0px"}, e.spinSpeed, "linear", function () {
                e.lowerSpeed();
            });
        }, lowerSpeed: function () {
            ...
            e.$el.css("top", -d.listHeight).animate({top: f}, h, d.options.easing, function () {
                d.checkWinner(g, e);
            });
        }};
